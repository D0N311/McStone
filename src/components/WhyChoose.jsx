  ...
  const features = [
    {
      ...
      description:
        "Every project undergoes rigorous quality control to ensure the highest standards are met.",
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Get the best value for your investment with our transparent and fair pricing.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            We are committed to delivering exceptional metal fabrication
            services that exceed expectations. Here's what sets us apart from
            the competition.
          </p>
        </div>
